<?php $__env->startSection('page-title', 'Gestion des Stocks'); ?>
...
<div class="space-y-6" x-data="stocksPage()">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        ...
        <div class="flex items-center gap-3">
            <form action="<?php echo e(route('stocks.index')); ?>" method="GET" class="flex items-center">
                <div class="relative">
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Rechercher un article..."
                ...
                <a href="<?php echo e(route('stocks.index')); ?>" class="ml-2 text-gray-500 hover:text-red-500 text-sm" title="Effacer">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($stocks->count()); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stocks->sum(fn($s) => $s->quantite * $s->prixVente), 0, ',', ' ')); ?> cfa</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($stocks->where('quantite', '<', 10)->count()); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stocks->sum(fn($s) => ($s->prixVente - $s->prixAchat) * $s->quantite), 0, ',', ' ')); ?> cfa</p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($item->nom); ?></td>
                        <td class="px-6 py-4">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($item->quantite < 10 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                                <?php echo e($item->quantite); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format($item->prixAchat, 0, ',', ' ')); ?> cfa</td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format($item->prixVente, 0, ',', ' ')); ?> cfa</td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format($item->quantite * $item->prixVente, 0, ',', ' ')); ?> cfa</td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format(($item->prixVente - $item->prixAchat) * $item->quantite, 0, ',', ' ')); ?> cfa</td>
                        <td class="px-6 py-4 text-sm space-x-2">
                            <button @click="openReappro(<?php echo e($item->toJson()); ?>)"
                                    class="text-green-600 hover:text-green-800 p-1" title="Réapprovisionner">
                                <i class="fas fa-truck-loading"></i>
                            </button>
                            <button @click="openHistorique('<?php echo e($item->id); ?>', '<?php echo e(addslashes($item->nom)); ?>')"
                                    class="text-purple-600 hover:text-purple-800 p-1" title="Historique réappro">
                                <i class="fas fa-history"></i>
                            </button>
                            <button @click="openEdit(<?php echo e($item->toJson()); ?>)"
                                    class="text-blue-600 hover:text-blue-800 p-1">
                                <i class="fas fa-pen"></i>
                            </button>
                            <form action="<?php echo e(route('stocks.destroy', $item->id)); ?>" method="POST" class="inline"
    ...
    <div x-show="showAdd" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4" @click.self="showAdd = false">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
            ...
            <form action="<?php echo e(route('stocks.store')); ?>" method="POST" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /data/projects/node.js/momotechservice/momotech-app/resources/views/dashboard/stocks.blade.php ENDPATH**/ ?>