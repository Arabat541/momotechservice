...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <form method="POST" action="{{ route('purchase-invoices.paiement', $invoice->id) }}" class="space-y-3">
            @csrf
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Moyen(s) de paiement</label>
                <x-paiement-mixte name-prefix="lignes" :total="$invoice->reste_a_payer" :show-cheque-virement="true" />
            </div>
            <div>
