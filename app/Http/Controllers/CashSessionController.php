...
class CashSessionController extends Controller
{
    ...
    public function zReport(Request $request, string $id)
    {
        ...
        $repairPayments    = RepairPayment::where('cash_session_id', $session->id)->get();
        $totalRepairs      = $repairPayments->sum('montant');
        $nbRepairPayments  = $repairPayments->count();
        ...
        $report = [
            ...
            'nb_paiements_reparations' => $nbRepairPayments,
            'total_paiements_reparations' => $totalRepairs,
            'total_encaisse'           => $ventesComptant->sum('montant_paye') + $totalRepairs,
